    ...
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: '#d4a017' }}>ERP & POS System</p>
          <p className="text-gray-600 text-xs mt-0.5">Konyo-Konyo Market · Juba, South Sudan</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 rounded-2xl font-bold text-sm mt-1 disabled:opacity-60 flex items-center justify-center gap-2 text-black"
              style={{ background: '#d4a017' }}
            >
              {isLoading && <span className="w-5 h-5 border-2 border-black border-t-transparent rounded-full animate-spin"/>}
              Sign In
            </button>
          </form>
        </div>
        ...
        <div className="text-center mt-5 space-y-1">
          ...
          <p className="text-gray-400 text-xs">Contact your system administrator.</p>
          <p className="text-gray-600 text-xs font-semibold">Admin-created accounts only.</p>
        </div>
      </div>
    </div>
  );
